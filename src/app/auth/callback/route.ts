...
const supabaseUrl =
  process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://ghadnqoihfdnceoamoid.supabase.co';
const supabaseAnonKey =
  process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'sb_publishable_3raaSMUJeZq5_MN7QGnFmA_AsZ3oF3X';
